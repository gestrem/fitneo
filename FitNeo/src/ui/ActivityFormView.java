...
public class ActivityFormView extends JPanel {
	...
	public ActivityFormView() {
		...
		springLayout.putConstraint(SpringLayout.NORTH, textField, 6, SpringLayout.SOUTH, lblDetailedDescription);
		springLayout.putConstraint(SpringLayout.WEST, textField, 65, SpringLayout.EAST, tf_ShortDesc);
		springLayout.putConstraint(SpringLayout.SOUTH, textField, 0, SpringLayout.SOUTH, tf_ActivityManager);
		springLayout.putConstraint(SpringLayout.EAST, textField, -87, SpringLayout.EAST, this);
		add(textField);
		textField.setColumns(10);
		
		JButton buttonCancel = new JButton("Cancel");
		springLayout.putConstraint(SpringLayout.NORTH, buttonCancel, 54, SpringLayout.SOUTH, textField);
		...
		springLayout.putConstraint(SpringLayout.NORTH, buttonValid, 54, SpringLayout.SOUTH, textField);
